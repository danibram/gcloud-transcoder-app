...
const TemplatesPage: Component<TemplatesPageProps> = (props) => {
    ...
    const fetchTemplates = async () => {
        try {
            ...
            setError(err instanceof Error ? err.message : 'Failed to fetch job templates');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const handleDelete = async (template: JobTemplate) => {
        ...
        try {
            ...
            await api.templateDelete(templateId);
            await fetchTemplates();
        } catch (err) {
